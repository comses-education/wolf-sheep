...
```{r}
require(ggplot2)
dynamicCsv <- getURL("https://dev.commons.asu.edu/data/abmclub/wolf-sheep/dynamic.csv")
E1<-read.csv(textConnection(dynamicCsv), header = TRUE,skip = 6,comment.char ="#")
...
data.exp2 <- read.csv(textConnection(staticCsv), skip = 6, header = T)
