...
```{r}
require(ggplot2)
E1<-read.csv(url("https://dev.commons.asu.edu/data/abmclub/wolf-sheep/dynamic.csv"), header = TRUE,skip = 6,comment.char ="#")
...
```{r}
data.exp2 <- read.csv(url("https://dev.commons.asu.edu/data/abmclub/wolf-sheep/static.csv"), skip = 6, header = T)
