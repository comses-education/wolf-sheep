...
<experiments>
  ...
  <experiment name="vary_food_gains_simple" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <exitCondition>not any? turtles</exitCondition>
  ...
  <experiment name="vary_food_gains_osg" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <exitCondition>not any? turtles</exitCondition>
